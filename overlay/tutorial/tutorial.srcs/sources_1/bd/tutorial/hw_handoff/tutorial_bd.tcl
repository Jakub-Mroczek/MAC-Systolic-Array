...
proc create_hier_cell_mm_eval { parentCell nameHier } {
  ...
  # Create instance: mm_0, and set properties
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins mm_0/x]
  ...
  connect_bd_intf_net -intf_net mm_0_y [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins mm_0/y]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins clk] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins mm_0/clk]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins rst_n] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins mm_0/rst_n]
